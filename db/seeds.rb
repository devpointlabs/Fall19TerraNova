...
Booking.create(start_date: "2019-10-20", end_date: "2019-10-23", guests: 4, expected_arrival: "12:00PM", special_needs: "NONE", booking_number: 000000, user_id: 1, cabin_id: 5, cabin_type: "A", price: 300, customer_payment_token: " cus_1")
...
Booking.create(start_date: "2019-10-20", end_date: "2019-10-21", guests: 4, expected_arrival: "12:00PM", special_needs: "NONE", booking_number: 222222, user_id: 2, cabin_id: 2, cabin_type: "A", price: 300, customer_payment_token: " cus_3")
...
Booking.create(start_date: "2019-10-20", end_date: "2019-10-28", guests: 4, expected_arrival: "12:00PM", special_needs: "NONE", user_id: 1, cabin_id: 5, cabin_type: "B", price: 300, customer_payment_token: " cus_6")
Booking.count == 6 ? (puts "6 bookings were created") : (puts "CREATING BOOKING ERRROR")
Priceevent.create(name: "Spring", start_date: "2019-03-19", end_date: "2019-06-20", multiplier: 0.05, recurring: true)
Priceevent.create(name: "Summer", start_date: "2019-06-21", end_date: "2019-09-22", multiplier: 0.25, recurring: true)
Priceevent.create(name: "Fall", start_date: "2019-09-23", end_date: "2019-12-21", multiplier: 0.20, recurring: true)
Priceevent.create(name: "Winter", start_date: "2019-12-22", end_date: "2020-03-18", multiplier: 0.005, recurring: true)
Priceevent.create(name: "Weekends", multiplier: 0.05, recurring: true)
Priceevent.create(name: "Recurring", start_date: "2018-12-15", end_date: "2019-01-10", adder: 120, recurring: true)
Priceevent.create(name: "Cabin1RangeIncrease", start_date: "2019-10-03", end_date: "2019-12-05", cabin_id: 1, multiplier: 0.05)
