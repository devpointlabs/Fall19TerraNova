...
Priceevent.create(name: "Spring", start_date: "2019-03-19", end_date: "2019-06-20", multiplier: 1.15, recurring: true)
Priceevent.create(name: "Summer", start_date: "2019-06-21", end_date: "2019-09-22", multiplier: 2, recurring: true)
Priceevent.create(name: "Fall", start_date: "2019-09-23", end_date: "2019-12-21", multiplier: 1.75, recurring: true)
Priceevent.create(name: "Winter", start_date: "2019-12-22", end_date: "2020-03-18", multiplier: 1.05, recurring: true)
Priceevent.create(name: "Weekends", multiplier: 1.25, recurring: true)
Priceevent.create(name: "Cabin1RangeIncrease", start_date: "2019-05-29", end_date: "2019-07-18", cabin_id: 1, multiplier: 1.05)
Priceevent.create(name: "Area51Raid", start_date: "2019-09-22", end_date: "2019-10-18", adder: 100)  
...
# add or multiply
# instance of a date better #?
# would it be better to pass base cabin price off to this table?